  ...
  return (
    <div className="bottom-[calc(env(safe-area-inset-bottom,0px)+6.25rem)] md:bottom-[calc(env(safe-area-inset-bottom,0px)+1rem)] pointer-events-none fixed right-4 z-40 flex flex-col items-end gap-4 sm:right-6">
      ...
      >
        ...
        <span
          className="absolute right-16 whitespace-nowrap rounded-full border border-white/10 px-4 py-2 font-data text-[10px] font-semibold uppercase tracking-widest text-white opacity-0 shadow-lg backdrop-blur-md transition-all duration-300 group-hover:opacity-100 group-hover:-translate-x-1"
